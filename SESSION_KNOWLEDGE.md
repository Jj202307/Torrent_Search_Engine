...
- **US & Canada TV forums MISSING from FORUM_DIRECTORY:** real leaf ids f=235 (США/Канады standard), f=266 (HD), f=1669 (UHD) — live-extracted from td[2] viewforum links on a site-wide search. tv-series preset therefore can't find US shows ('severance' in 842/119/2366/1803 → all 0; in f=266/1669 → 6 rows each). OPEN ITEM: rebuild FORUM_DIRECTORY by walking the real branch tree (trick: any search page's td[2] carries a[viewforum.php?f=NN] with the true id+name).
